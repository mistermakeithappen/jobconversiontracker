...
async function getPITToken() {
  ...
  console.log('Encrypted:', apiKey.encrypted_api_key ? 'Yes' : 'No');
  console.log('All fields:', Object.keys(apiKey));
  ...
  if (integration) {
    ...
    console.log(`export GHL_MCP_PIT_TOKEN="${apiKey.api_key}"`);
...
getPITToken().catch(console.error);